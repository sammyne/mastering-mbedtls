...
int main()
{
    ...
    // encrypt
    {
        ...
        //cout << "[ENCRYPTION] ciphertext = " << hex::encode(ciphertext) << endl;
        ...
        //cout << "[ENCRYPTION] out = " << hex::encode(out, out_len) << endl;
    ...
    // decrypt
    {
        ...
        status = mbedtls_cipher_update(
            &ctx, ciphertext.data(), ciphertext.size(),
        ...
        cout << "[DECRYPTION] recovered = " << hex::encode(recovered) << endl;
        ...
        auto v2 = hex::encode(recovered.data(), msg.size());
        if (v1 != v2)
        {
